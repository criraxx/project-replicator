// Mock data and types for the CEBIO system
...
export const mockProjects: Project[] = [
  { id: 1, title: "Biopesticidas para controle de pragas em culturas de soja", summary: "Desenvolvimento de biopesticidas à base de Bacillus thuringiensis", description: "Pesquisa focada no desenvolvimento de formulações biológicas...", category: "Bioinsumos", academic_level: "Mestrado", status: "aprovado", owner_id: 2, owner_name: "Dr. Carlos Silva", owner_email: "carlos@ifgoiano.edu.br", created_at: "2025-01-15T10:00:00Z", updated_at: "2025-03-10T14:00:00Z", version: 3 },
  { id: 2, title: "Biofertilizantes a base de microalgas", summary: "Estudo da eficácia de microalgas como biofertilizantes", description: "Avaliação do potencial de Chlorella e Spirulina...", category: "Biotecnologia", academic_level: "Doutorado", status: "pendente", owner_id: 2, owner_name: "Dra. Ana Paula Oliveira", owner_email: "ana@ifgoiano.edu.br", created_at: "2025-02-20T08:30:00Z", updated_at: "2025-02-20T08:30:00Z", version: 1 },
  { id: 3, title: "Fungos entomopatogênicos no controle biológico", summary: "Isolamento e caracterização de fungos entomopatogênicos nativos", description: "Coleta e identificação de isolados de Beauveria bassiana...", category: "Meio Ambiente", academic_level: "Graduação", status: "em_revisao", owner_id: 3, owner_name: "Maria Santos", owner_email: "maria@ifgoiano.edu.br", created_at: "2025-03-01T09:00:00Z", updated_at: "2025-03-15T11:00:00Z", version: 2 },
  { id: 4, title: "Compostagem com microrganismos eficientes", summary: "Aceleração do processo de compostagem com EM", description: "Aplicação de microrganismos eficientes para otimizar...", category: "Agronomia", academic_level: "Técnico", status: "rejeitado", owner_id: 4, owner_name: "João Pereira", owner_email: "joao@ifgoiano.edu.br", created_at: "2025-01-10T07:00:00Z", updated_at: "2025-02-05T16:00:00Z", rejection_reason: "Falta de detalhamento metodológico", version: 1 },
  { id: 5, title: "Bioestimulantes para produção de hortaliças orgânicas", summary: "Avaliação de bioestimulantes naturais em cultivo orgânico", description: "Testes com ácidos húmicos e fúlvicos...", category: "Bioinsumos", academic_level: "Mestrado", status: "aprovado", owner_id: 2, owner_name: "Dr. Carlos Silva", owner_email: "carlos@ifgoiano.edu.br", created_at: "2024-11-20T10:00:00Z", updated_at: "2025-01-10T09:00:00Z", version: 4 },
  { id: 6, title: "Rizobactérias promotoras de crescimento vegetal", summary: "Seleção de RPCP para inoculação em gramíneas forrageiras", description: "Isolamento de bactérias do gênero Azospirillum...", category: "Biotecnologia", academic_level: "Doutorado", status: "pendente", owner_id: 5, owner_name: "Pedro Almeida", owner_email: "pedro@ifgoiano.edu.br", created_at: "2025-03-20T14:00:00Z", updated_at: "2025-03-20T14:00:00Z", version: 1 },
  { id: 7, title: "Trichoderma no manejo de doenças do solo", summary: "Uso de Trichoderma harzianum como agente de biocontrole", description: "Avaliação in vitro e in vivo da eficácia...", category: "Meio Ambiente", academic_level: "Graduação", status: "aprovado", owner_id: 3, owner_name: "Maria Santos", owner_email: "maria@ifgoiano.edu.br", created_at: "2024-10-05T08:00:00Z", updated_at: "2024-12-15T10:00:00Z", version: 5 },
  { id: 8, title: "Nematoides entomopatogênicos em controle biológico", summary: "Prospecção de nematoides para controle de insetos-praga", description: "Coleta de amostras de solo em diferentes biomas...", category: "Bioinsumos", academic_level: "Mestrado", status: "em_revisao", owner_id: 6, owner_name: "Luiza Fernandes", owner_email: "luiza@ifgoiano.edu.br", created_at: "2025-02-10T11:00:00Z", updated_at: "2025-03-18T15:00:00Z", version: 2 },
];

export const mockUsers: User[] = [
  { id: 1, name: "Administrador", email: "admin@cebio.com", role: "admin", institution: "IF Goiano - Campus Iporá", is_active: true, created_at: "2024-01-01T00:00:00Z", last_login: "2025-04-09T08:00:00Z" },
  { id: 2, name: "Dr. Carlos Silva", email: "carlos@ifgoiano.edu.br", role: "pesquisador", institution: "IF Goiano - Campus Iporá", is_active: true, created_at: "2024-03-15T10:00:00Z", last_login: "2025-04-08T14:30:00Z" },
  { id: 3, name: "Maria Santos", email: "maria@ifgoiano.edu.br", role: "bolsista", institution: "IF Goiano - Campus Iporá", is_active: true, created_at: "2024-06-01T08:00:00Z", last_login: "2025-04-07T16:00:00Z" },
...
export const mockAuditLogs: AuditLog[] = [
  { id: 1, action: "PROJECT_APPROVED", user_id: 1, user_name: "Administrador", target_project_id: 1, details: "Projeto 'Biopesticidas' aprovado", severity: "medium", ip_address: "192.168.1.1", created_at: "2025-04-09T08:00:00Z" },
  { id: 2, action: "USER_CREATED", user_id: 1, user_name: "Administrador", details: "Usuário 'Luiza Fernandes' criado", severity: "medium", ip_address: "192.168.1.1", created_at: "2025-04-08T14:00:00Z" },
  ...
  { id: 4, action: "PASSWORD_RESET", user_id: 1, user_name: "Administrador", details: "Senha resetada para joao@ifgoiano.edu.br", severity: "high", ip_address: "192.168.1.1", created_at: "2025-04-07T16:00:00Z" },
  { id: 5, action: "PROJECT_REJECTED", user_id: 1, user_name: "Administrador", target_project_id: 4, details: "Projeto 'Compostagem' rejeitado", severity: "medium", ip_address: "192.168.1.1", created_at: "2025-04-07T10:00:00Z" },
  ...
  { id: 7, action: "USER_DEACTIVATED", user_id: 1, user_name: "Administrador", details: "Usuário 'João Pereira' desativado", severity: "high", ip_address: "192.168.1.1", created_at: "2025-04-06T15:00:00Z" },
