...
import { Clock, CheckCircle, FileText, Download, Inbox } from "lucide-react";
...
const PesquisadorHistory = () => {
  ...
  return (
    <AppLayout pageName="Histórico de Atividades" navItems={PESQUISADOR_NAV} notificationCount={0}>
      {/* Banner */}
        ...
        <div className="grid grid-cols-4 gap-4 items-end">
          ...
          <div>
            ...
            <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="w-full px-3 py-2.5 border border-border rounded-lg text-sm bg-card">
              <option value="">Todos</option><option>Submissão</option><option>Revisão</option><option>Aprovação</option><option>Rejeição</option>
            </select>
          </div>
          <div>
