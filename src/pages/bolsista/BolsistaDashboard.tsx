    ...
    <AppLayout pageName="Meu Dashboard" navItems={BOLSISTA_NAV} notificationCount={0}>
      ...
      <div className="bg-gradient-to-r from-primary via-secondary to-green-700 text-primary-foreground rounded-xl p-7 mb-6 flex justify-between items-start">
        <div>
          ...
          <p className="text-sm opacity-90 mb-1">Bolsista • CEBIO Brasil - Centro de Excelência em Bioinsumos</p>
          <p className="text-[13px] opacity-85 mb-3">Gerencie seus projetos acadêmicos e acompanhe o progresso das submissões</p>
          <button onClick={() => navigate("/bolsista/submissao")} className="bg-primary-foreground/20 hover:bg-primary-foreground/30 text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium transition-colors">
            + Nova Submissão
          </button>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-5">
            ...
            <div className="space-y-2">
              <button onClick={() => navigate("/bolsista/submissao")} className="w-full flex items-center gap-2 p-3 border border-border rounded-lg hover:bg-muted/50 transition-colors text-sm font-medium">
                <Plus className="w-4 h-4 text-primary" /> Nova Submissão
              </button>
              <button onClick={() => navigate("/bolsista/historico")} className="w-full flex items-center gap-2 p-3 border border-border rounded-lg hover:bg-muted/50 transition-colors text-sm font-medium">
