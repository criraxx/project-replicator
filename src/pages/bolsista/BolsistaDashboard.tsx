        ...
        <div className="space-y-4">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-5">
            ...
            <div className="space-y-2">
              <button onClick={() => navigate("/bolsista/submissao")} className="w-full flex items-center gap-2 p-2.5 rounded-lg hover:bg-muted/50 transition-colors text-sm text-left">
                <Plus className="w-4 h-4 text-primary" /> Nova Submissão
              </button>
              <button onClick={() => navigate("/bolsista/historico")} className="w-full flex items-center gap-2 p-2.5 rounded-lg hover:bg-muted/50 transition-colors text-sm text-left">
